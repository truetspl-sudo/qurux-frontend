          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
            <div className="mx-auto max-w-6xl">
              <p className="flex flex-wrap items-center gap-3">
                ...
                {salon.type && (
                  <span className="rounded-full bg-white/15 px-2.5 py-0.5 text-xs font-bold uppercase tracking-wide text-white ring-1 ring-white/30">
                    {String(salon.type).toUpperCase() === "WOMEN_ONLY" || String(salon.type).toUpperCase() === "WOMENS"
                      ? "👩 Women Only"
                      : String(salon.type).toUpperCase() === "MENS"
                        ? "👨 Men Only"
                        : "👥 Unisex"}
                  </span>
                )}
